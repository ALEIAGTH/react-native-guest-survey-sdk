...
RCT_EXTERN_METHOD(configure: (NSString)secretKey language:(NSString)language enableDebugging:(BOOL)enableDebugging callback:(RCTResponseSenderBlock)callback)
RCT_EXTERN_METHOD(startCollection: (NSString)user_Id)
RCT_EXTERN_METHOD(stopCollection)
RCT_EXTERN_METHOD(triggerSurvey: (NSString)programKey withEvent:(NSString)eventName)
